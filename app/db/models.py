...
class Office(Base):
    ...
    def __eq__(self, other):
        return self.id == other.id and self.name == other.name and self.spaces == self.spaces
...
class Livingspace(Base):
    ...
    def __eq__(self, other):
        return self.id == other.id and self.name == other.name and self.spaces == other.spaces
